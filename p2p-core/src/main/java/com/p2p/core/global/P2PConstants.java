...
public class P2PConstants {
	...
	public static class MsgSection{
		...
		//绗簩娆℃坊鍔�
				...
				public static int MESG_SET_DEFENCE_SWITCH=135000;
				public static int MESG_GET_DEFENCE_AREA_NAME=136000;
				public static int MESG_SET_DEFENCE_AREA_NAME=137000;
				public static int GPIO_STATUS=138000;
			    public static int GET_GPIO_STATUS=139000;
                public static int MESG_ID_AUTO_SNAPSHOT_SWITCH=140000;
                public static int GET_PIRLIGHT=141000;
                public static int SET_PIRLIGHT=142000;
			    public static int GET_FISHEYE_INFO=143000;
			    public static int SET_FISHEYE_INFO=144000;
			    public static int MESG_GET_LED_STATE=145000;
			    public static int MESG_SET_LED_STATE=146000;
			    public static int MESG_ID_FISHEYE_SET_SENSOR_PREPOINT=147000;
			    public static int MESG_GET_VIDEO_COLOR = 148000;
		        public static int MESG_SET_VIDEO_COLOR = 149000;
				public static int MSG_ID_SETTING_NPC_SETTINGS_MOTION_SENS = 150000;
                public static int MESG_GET_VIDEO_QUALITY=151000;
                public static int MESG_SET_VIDEO_QUALITY=152000;
		public static int MESG_GET_IRLED=153000;
		public static int MESG_SET_IRLED=154000;
                public static int MESG_GET_AP_IF_WIFI_SETTING=155000;
                public static int MESG_SET_AP_STA_WIFI_INFO = 156000;
    }
	...
	public static class P2P_SETTING{
		...
		public static class SETTING_TYPE{
			...
			public static final int STTING_ID_MOTION_SENS=28; //移动侦测灵敏度
			public static final int SETTING_ID_LAMP=34;
			public static final int SETTING_ID_GET_PRESET_POS_SUPPORT2=36;//之前设备是36代表支持记忆点，公版不用这个标记
			...
			public static final int SETTING_ID_DEVICE_TYPE=41;//获取设备类型
			public static final int SETTING_ID_FISHEYE_INSTALL_POS=42;//鱼眼
			public static final int SETTING_DEFENCE_SWITCH=43;//带名字防区开关
			public static final int SETTING_LIGHTCONTROL=44;//PIR灯光控制
            public static final int SETTING_AUTO_SNAPSHOT=45;//10分钟自动拍照
            public static final int SETTING_ID_GET_PRESET_POS_SUPPORT=46;//是否支持记忆点
			public static final int SETTING_ID_GET_IRLED_SUPPORT=48;//红外LED关闭
		}
