...
public class SelectPlaceListAdapter extends BaseAdapter {
	private Context mContext;
	private List<CxwyXiangmu> listDatas;
	...
	public SelectPlaceListAdapter(List<CxwyXiangmu> listData,
			Context context) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		// 加载数据
		final CxwyXiangmu goodsVo = listDatas.get(position);

		holder.secondName.setText(goodsVo.getXiangmuLoupan());
		return convertView;
	}

	public List<CxwyXiangmu> getListDatas() {
		return listDatas;
	}

	public void setListDatas(List<CxwyXiangmu> listDatas) {
