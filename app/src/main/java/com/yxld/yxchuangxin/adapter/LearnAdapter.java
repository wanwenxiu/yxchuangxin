...
public class LearnAdapter extends BaseMultiItemQuickAdapter<MultiItemEntity,BaseViewHolder> {
    ...
    public LearnAdapter(List<MultiItemEntity> data) {
        super(data);
            ...
            case TYPE_LEVEL_1:
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (lv1.title==1){
                            Log.d("...", "1");
                            P2PHandler.getInstance().setDefenceAreaState("5969657","123",lv1.lines,lv1.few,0);
                            P2PHandler.getInstance().getDefenceArea("5969657","123");
                        }else {
                            Log.d("...", "0");
                            P2PHandler.getInstance().setDefenceAreaState("5969657","123",lv1.lines,lv1.few,1);
                            P2PHandler.getInstance().getDefenceArea("5969657", "123");
                        }
                    }
                });
