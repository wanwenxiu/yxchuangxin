...
public class NoCouponAdapter extends BaseAdapter {
    ...
    public NoCouponAdapter(List<CxwyMallUseDaijinquan> list, Context context) {
    ...
    public View getView(int position, // 当前要构造的位置
        ...
        if (view == null) {
            ...
            // 构造视图
            view = lif.inflate(R.layout.activity_nocoupon_item, null);
            // 找到控件
            holder.tv_money = (TextView) view.findViewById(R.id.no_coupon_money);
            holder.tv_red1 = (TextView) view.findViewById(R.id.no_red1);
            holder.tv_red2 = (TextView) view.findViewById(R.id.no_red2);
            holder.tv_red3 = (TextView) view.findViewById(R.id.no_red3);
            holder.tv_red4 = (TextView) view.findViewById(R.id.no_red4);
            holder.tv_status= (SlantedTextView) view.findViewById(R.id.no_status);
            view.setTag(holder);
        } else {
