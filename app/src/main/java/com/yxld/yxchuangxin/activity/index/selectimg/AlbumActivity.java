...
import com.yxld.yxchuangxin.activity.index.selectimg.adapter.AlbumGridViewAdapter;
...
import com.yxld.yxchuangxin.activity.index.selectimg.util.ImageBucket;
...
public class AlbumActivity extends Activity {
	...
	private class AlbumSendListener implements OnClickListener {
		public void onClick(View v) {
			...
			intent.setClass(mContext, Repair.class);
			startActivity(intent);
			finish();
		}
