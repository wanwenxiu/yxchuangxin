...
public class XListView extends ListView implements OnScrollListener {
	...
	public void setBgColor(int color){
		...
		mHeaderView.findViewById(R.id.ly_header).setBackgroundColor(color);
		mFooterView.findViewById(R.id.ly_footer).setBackgroundColor(color);
	}
//	@Override
...
//	}
	...
	private boolean xEnable = true;
	public void setXEnable(boolean enable){
		this.xEnable = enable;
	}
	@Override
